...
export class EspLoader {
    constructor(serialPort, options) {
        ...
        this._sendCommandBuffer = new Uint8BufferSlipEncode();
        this._flashBlockBuffer = new Uint8Buffer();
        this._memBlockBuffer = new Uint8Buffer();
    ...
    async flashBegin(size = 0, offset = 0, encrypted = false) {
        ...
        this.logger.log("Write size", eraseSize, " blocks ", numBlocks, " block size ", flashWriteSize, " offset " + toHex(offset, 4) // + ", encrypted " + (encrypted ? "yes" : "no")
        );
